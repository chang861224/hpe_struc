...
int main(int argc, char **argv){
    ...
    if (argc == 1) {
        ...
        printf("\t-use_structure <int>\n");
        printf("\t\tUse structural or not; default is 0(false)\n");
    ...
    char* network_file = new char[100];
    char* rep_file = new char[100];
    char* load_v = new char[100];
    char* load_c = new char[100];
    ...
    if ((i = ArgPos((char *)"-use_structure", argc, argv)) > 0) structure = atoi(argv[i + 1]);
